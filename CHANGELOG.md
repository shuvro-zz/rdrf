...
[Full Changelog](https://github.com/muccg/rdrf/compare/1.6.3...HEAD)
...
- Lettuce: running without alert confirmation hacks [\#43](https://github.com/muccg/rdrf/pull/43) ([sztamas](https://github.com/sztamas))
- Lettuce teardown and vnc [\#42](https://github.com/muccg/rdrf/pull/42) ([aahunter](https://github.com/aahunter))
- Run lettuce against prod release [\#41](https://github.com/muccg/rdrf/pull/41) ([aahunter](https://github.com/aahunter))
- Python lint [\#40](https://github.com/muccg/rdrf/pull/40) ([aahunter](https://github.com/aahunter))
...
- Requirements for downstream projects [\#39](https://github.com/muccg/rdrf/pull/39) ([aahunter](https://github.com/aahunter))
- Python Lint [\#38](https://github.com/muccg/rdrf/pull/38) ([ccgbuildbot](https://github.com/ccgbuildbot))
- 1.6 [\#37](https://github.com/muccg/rdrf/pull/37) ([aahunter](https://github.com/aahunter))
- see if we can add conditional stages to jenkinsfile [\#36](https://github.com/muccg/rdrf/pull/36) ([aahunter](https://github.com/aahunter))
...
- Fhcreatemode [\#34](https://github.com/muccg/rdrf/pull/34) ([id2359](https://github.com/id2359))
- colour jenkins console output [\#32](https://github.com/muccg/rdrf/pull/32) ([aahunter](https://github.com/aahunter))
- Jenkinsfile [\#30](https://github.com/muccg/rdrf/pull/30) ([aahunter](https://github.com/aahunter))
- rdr-1390-anymail [\#29](https://github.com/muccg/rdrf/pull/29) ([aahunter](https://github.com/aahunter))
- RDR-1221: Add the required permissions by each group [\#28](https://github.com/muccg/rdrf/pull/28) ([sztamas](https://github.com/sztamas))
- Relax User validation, move permissions and grid config out of settings [\#27](https://github.com/muccg/rdrf/pull/27) ([sztamas](https://github.com/sztamas))
...
- RDRF-1373: Patient Listing Page - handle edge cases better [\#26](https://github.com/muccg/rdrf/pull/26) ([sztamas](https://github.com/sztamas))
...
- RDR-1359 nocdn missing staticfiles tag [\#25](https://github.com/muccg/rdrf/pull/25) ([aahunter](https://github.com/aahunter))
- Upgrade to django-iprestrict 0.4.3 [\#24](https://github.com/muccg/rdrf/pull/24) ([sztamas](https://github.com/sztamas))
...
- RDR-1363 iprestrict settings [\#23](https://github.com/muccg/rdrf/pull/23) ([aahunter](https://github.com/aahunter))
...
- RDR-1362 add root logger [\#22](https://github.com/muccg/rdrf/pull/22) ([aahunter](https://github.com/aahunter))
...
- Rdr 1356 auth consent view [\#21](https://github.com/muccg/rdrf/pull/21) ([aahunter](https://github.com/aahunter))
- RDR 1359 no cdn [\#20](https://github.com/muccg/rdrf/pull/20) ([aahunter](https://github.com/aahunter))
- RDR 1358 remove suits [\#19](https://github.com/muccg/rdrf/pull/19) ([aahunter](https://github.com/aahunter))
- Rdr 1357 deprecate django secure [\#18](https://github.com/muccg/rdrf/pull/18) ([aahunter](https://github.com/aahunter))
- RDR-1350 pymongo 2.9.3 [\#16](https://github.com/muccg/rdrf/pull/16) ([aahunter](https://github.com/aahunter))
- RDR-1348 Minor Python dependency upgrades [\#15](https://github.com/muccg/rdrf/pull/15) ([aahunter](https://github.com/aahunter))
- Rdr 1339 docker docker compose upgrade [\#14](https://github.com/muccg/rdrf/pull/14) ([aahunter](https://github.com/aahunter))
- Add a script for running registry yaml csv test cases [\#13](https://github.com/muccg/rdrf/pull/13) ([rvl](https://github.com/rvl))
- Exporter/importer initial version. [\#6](https://github.com/muccg/rdrf/pull/6) ([sztamas](https://github.com/sztamas))
...
- Django file storage [\#9](https://github.com/muccg/rdrf/pull/9) ([rvl](https://github.com/rvl))
...
- Init management command [\#12](https://github.com/muccg/rdrf/pull/12) ([sztamas](https://github.com/sztamas))
...
- Fix for RDR-1301 handling of non-ascii CDE calculation scripts [\#11](https://github.com/muccg/rdrf/pull/11) ([rvl](https://github.com/rvl))
...
- CDE Value History Charts and Revert [\#8](https://github.com/muccg/rdrf/pull/8) ([rvl](https://github.com/rvl))
...
- Logging settings [\#10](https://github.com/muccg/rdrf/pull/10) ([rvl](https://github.com/rvl))
...
- RDR-1256 Registry code is read-only [\#5](https://github.com/muccg/rdrf/pull/5) ([rvl](https://github.com/rvl))
...
- Tweaks [\#2](https://github.com/muccg/rdrf/pull/2) ([rvl](https://github.com/rvl))
...
- CDE calculation javascript security validation [\#4](https://github.com/muccg/rdrf/pull/4) ([rvl](https://github.com/rvl))
- Rest api [\#1](https://github.com/muccg/rdrf/pull/1) ([sztamas](https://github.com/sztamas))
